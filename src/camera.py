...
class Camera:
    ...
    def __init__(self, scene, width, height, fov, dλ, maxλ):
        ...
        self.dλ = dλ
        self.maxλ = maxλ
        self.scene.black_hole.dλ = self.dλ
    ...
    def ray_trace(self, height_index, width_index):
            ...
            while λ <= maxλ:
                ...
                # Olay Ufku Kontrolü (ışık eğer olay ufkuna bir adımdan daha az mesafeye geldiyse siyah döndür)
                if current_r <= (rs + max(3*dλ, rs*0.05)):
